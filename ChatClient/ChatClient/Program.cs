        ...
        private static void DoProcessing()
        {
             ...
             try
            {
                while (true)
                {
                    ...
                    int xp = SystemProperties.ClientStartRange + 1;
                    int kk = 0;
                    ...
                    while (kk < SystemProperties.TotalClients)
                    {
                         ...
                         try
                            {
                                ...
                                {
                                Console.WriteLine("Please Set reciever ID in properties file");
                                }

                           y: string text = Console.ReadLine();
                            if (!string.IsNullOrEmpty(text))
                            {
                                mypacket.payload = text;
                            }
                            else
                            {
                            ...
                            if (xs == SystemProperties.TotalClients - 3)
                            {
                                xp = SystemProperties.ClientStartRange + 1;
                                xs = 0;
                            }
